...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send('service_mgcs5g4', 'template_zkljizj', { from_name: form.name, to_name: 'Kristofer', from_email: form.email, to_email: 'krhoetmer@gmail.com', message: form.message }, 'NS7c9SyWBYrkUvAVF')
      .then(() => {
        setLoading(false);
